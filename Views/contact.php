...
<div class="container-fluid"  >
      <div class="text-center p-2 bg-light" style="opacity: 0.94;" >      
                    ...
                    <form action="<?php echo FRONT_ROOT.'/User/sendMail'; ?>" name="sentMessage" id="contactForm" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input name ="telefono" type="tel" class="form-control" placeholder="Telefono" id="phone"  data-validation-required-message="Please enter your phone number.">
                                        <p class="help-block text-danger"></p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-md-auto"> </div>
                                    <div class="col-md-auto ml-auto d-flex float-right" id="success">
                                        <input type="submit" class="bg-dark text-light p-2 d-block m-auto rounded" width="500px"  name="Enviar" value="ENVIAR"></div>
                                    </div>
                        </form>
                    </div>
                </div>
                      ...
                      <div class="row text-left p-5">
                          ...
                          <div class="col">
                                <h4 class="titulo p-7" style="color: rgb(165,24,24);">TELEFONOS DE CONTACTO</h4>
                                <h4 class="subTitulo my-3"> (0223) 451-XXXX </h4>
                                <h4 class="subTitulo my-3"> (0223) 451-XXXX </h4>
                                <h4 class="subTitulo my-3"> (0223) 451-XXXX </h4>
                          </div>
                          <div class="col">
                                <h4 class="titulo p-7" style="color: rgb(165,24,24);">MAIL</h4>
                                <h4 class="subTitulo my-3"> consultas@mooviepass.com.ar </h4>
                                <h4 class="titulo p-7" style="color: rgb(165,24,24);">ORIENTACION AL CONSUMIDOR</h4>
                                <h4 class="subTitulo my-3"> 0800-222-9042 </h4>
